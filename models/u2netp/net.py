...
class Net(nn.Module):
    ...
    def __init__(self, in_ch=3, mid_ch=16, out_ch=1, num_classes=20, share_classifier=False, *args, **kwargs):
        ...
        if self.share_classifier:
            self.classifier = nn.Conv2d(64, self.num_classes, 1, bias=False)
        else:
            self.classifier1 = nn.Conv2d(64, self.num_classes, 1, bias=False)
            self.classifier2 = nn.Conv2d(64, self.num_classes, 1, bias=False)
            self.classifier3 = nn.Conv2d(64, self.num_classes, 1, bias=False)
            self.classifier4 = nn.Conv2d(64, self.num_classes, 1, bias=False)
            self.classifier5 = nn.Conv2d(64, self.num_classes, 1, bias=False)
            self.classifier6 = nn.Conv2d(64, self.num_classes, 1, bias=False)
